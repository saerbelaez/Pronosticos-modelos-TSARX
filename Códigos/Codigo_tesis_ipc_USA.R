...
Base=fread("USACPIALLMINMEI.csv",sep = ",")
Datos=ts(Base$USACPIALLMINMEI[300:612],start=c(1984,12),freq=12)
Xt=diff(log(Datos))*100
spread=fread("spread_cpi.csv",sep=",")
str(spread$T10YFF)
spread$T10YFF=as.numeric(spread$T10YFF)

Zt=ts(spread$T10YFF[276:588],start = c(1984,12),freq=12)
Zt=ts(diff(Zt),start=c(1985,1),freq=12)
...
h=25
s=12
step.thv=0.005 #se ajusta el tamaño del paso de acuerdo con la tasa de aceptación
d0=3
...
pronosticos<-function(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
{
  ...
  for (i in 1:NN)
  {
    ...
    for (hh in 1:LH)
    {
      zv[nx+hh]=0.2200*zv[nx+hh-1]+rnorm(1, mean=0, sd=sqrt(0.0866))   ## SE CAMBIA LA FORMULA, el kernel de transici?n, variable umbral
    }
...
for (i in 0:110) {
  set.seed(525)
  Base=fread("USACPIALLMINMEI.csv",sep = ",")
  Datos=ts(Base$USACPIALLMINMEI[300:(612+(i))],start=c(1984,12),freq=12)
  
  Xt=diff(log(Datos))*100
  spread=fread("spread_cpi.csv",sep=",")
  spread$T10YFF=as.numeric(spread$T10YFF)
  Zt=ts(diff(spread$T10YFF[276:(588+(i))]),start = c(1984,12),freq=12)
  x2=Xt
  thresVar2=Zt
...
Comparacion=fread("USACPIALLMINMEI.csv",sep = ",")
Comparacion=Comparacion$USACPIALLMINMEI[612:723]
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_ipc_spread_usa.xlsx",overwrite = T)
...
for (i in 0:56) {
  set.seed(525)
  Base=fread("USACPIALLMINMEI.csv",sep = ",")
  Datos=ts(Base$USACPIALLMINMEI[300:(612+(2*i))],start=c(1984,12),freq=12)
  
  Xt=diff(log(Datos))*100
  spread=fread("spread_cpi.csv",sep=",")
  spread$T10YFF=as.numeric(spread$T10YFF)
  Zt=ts(diff(spread$T10YFF[276:(588+(2*i))]),start = c(1984,12),freq=12)
  x2=Xt
  thresVar2=Zt
  p=pronosticos(LH, x2, thresVar2, Iteration, Burnin, step.thv, d0)
  px=p$seriex
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_ipc_spread_usa.xlsx",overwrite = T)
...
for (i in 0:36) {
  set.seed(525)
  Base=fread("USACPIALLMINMEI.csv",sep = ",")
  Datos=ts(Base$USACPIALLMINMEI[300:(612+(3*i))],start=c(1984,12),freq=12)
  
  Xt=diff(log(Datos))*100
  spread=fread("spread_cpi.csv",sep=",")
  spread$T10YFF=as.numeric(spread$T10YFF)
  Zt=ts(diff(spread$T10YFF[276:(588+(3*i))]),start = c(1984,12),freq=12)
  x2=Xt
  thresVar2=Zt
  p=pronosticos(LH, x2, thresVar2, Iteration, Burnin, step.thv, d0)
  px=p$seriex
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_ipc_spread_usa.xlsx",overwrite = T)
...
for (i in 0:26) {
  set.seed(525)
  Base=fread("USACPIALLMINMEI.csv",sep = ",")
  Datos=ts(Base$USACPIALLMINMEI[300:(612+(4*i))],start=c(1984,12),freq=12)
  
  Xt=diff(log(Datos))*100
  spread=fread("spread_cpi.csv",sep=",")
  spread$T10YFF=as.numeric(spread$T10YFF)
  Zt=ts(diff(spread$T10YFF[276:(588+(4*i))]),start = c(1984,12),freq=12)
  x2=Xt
  thresVar2=Zt
  p=pronosticos(LH, x2, thresVar2, Iteration, Burnin, step.thv, d0)
  px=p$seriex
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_ipc_spread_usa.xlsx",overwrite = T)
