...
h=25
s=12
step.thv=0.025 #se ajusta el tamaño del paso de acuerdo con la tasa de aceptación 
d0=3
...
co=0.12262####Valor del cuantil aproximado para cusumsq para n/2
...
plot(Zt)
Modelo.zt=forecast::Arima(Zt,order=c(2,0,0),include.constant = F,fixed=c(0,NA))
...
pronosticos<-function(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
{
  ...
  for (i in 1:NN)
  {
    ...
    for (hh in 1:LH)
    {
      zv[nx+hh]=0.2219*zv[nx+hh-2]+rnorm(1, mean=0, sd=sqrt(0.0915))   ## SE CAMBIA LA FORMULA, el kernel de transici?n, variable umbral
    }
...
Pronostico=ts(AA[,1],start=c(2011,12),freq=12)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_ipc_spread_uk.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_ipc_spread_uk.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_ipc_spread_uk.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_ipc_spread_uk.xlsx",overwrite = T)
