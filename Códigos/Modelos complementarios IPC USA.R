...
pronosticos<-function(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
{
  ...
  for (i in 1:NN)
  {
    ...
    for (hh in 1:LH)
    {
      zv[nx+hh]= 0.2736*zv[nx+hh-1]+rnorm(1, mean=0, sd=sqrt(751.6))  ## el kernel de transici?n, variable umbral
    }  
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_1_ipc_spread_usa.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_2_ipc_spread_usa.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_3_ipc_spread_usa.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_4_ipc_spread_usa.xlsx",overwrite = T)
...
Modelo_ar=forecast::Arima(Xt,order=c(2,0,0),seasonal = c(2,0,0), include.mean = T,fixed=c(NA,NA,NA,NA,NA))
coeftest(Modelo_ar)
summary(Modelo_ar)
par(mfrow=c(2,1))
...
Af=0.948 ###Cuantil del 95% para la estad?stica cusum
co=0.1099####Valor del cuantil aproximado para cusumsq para n/2
...
for (i in 0:110) {
  ...
  Xt=diff(log(Datos))*100
  refit=Arima(Xt,order=c(2,0,0),seasonal = c(2,0,0), include.mean = T,fixed=c(NA,NA,NA,NA,NA),model=Modelo_ar)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_AR_ipc_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_AR_ipc_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_AR_ipc_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_AR_ipc_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_EXP_ipc_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_EXP_ipc_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_EXP_ipc_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_EXP_ipc_usa.xlsx",overwrite = T)
