...
Base=fread("PIB_est_uk.csv",sep=",")
Base$CPMNACNSAB1GQUK=as.numeric(Base$CPMNACNSAB1GQUK)
str(Base)
Datos=ts(Base[1:166,2],start=c(1975,1),freq=4)
par(mfrow=c(1,1))
Xt=diff(log(Datos))*100
Xt=diff(Xt)
str(Xt)
Xt=ts(Xt[12:164],start=c(1978,2),freq=4)

short=fread("short_term_uk_trim.csv",sep=",")
short$IRSTCI01GBM156N=as.numeric(short$IRSTCI01GBM156N)
long=fread("long_term_uk_trim.csv",sep=",")
long$IRLTLT01GBM156N=as.numeric(long$IRLTLT01GBM156N)
long=long[73:252,]
short_ts=ts(short$IRSTCI01GBM156N[1:154],start = c(1978,1),freq=4)
long_ts=ts(long$IRLTLT01GBM156N[1:154],start = c(1978,1),freq=4)
Datos=as.data.frame(cbind(long_ts,short_ts))
names(Datos)=c("long","short")
Datos$spread=Datos$long-Datos$short
spread=ts(Datos$spread,start=c(1978,1),freq=4)
Zt=diff(spread)
...
pronosticos<-function(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
{
  ...
  for (i in 1:NN)
  {
    ...
    for (hh in 1:LH)
    {
      zv[nx+hh]=0.1410*zv[nx+hh-1]+rnorm(1, mean=0, sd=sqrt(0.7525))  ## el kernel de transici?n, variable umbral
    }  
...
for (i in 0:14) {
  ...
  Base=fread("PIB_est_uk.csv",sep=",")
  Base$CPMNACNSAB1GQUK=as.numeric(Base$CPMNACNSAB1GQUK)
  Datos=ts(Base[,2],start=c(1975,1),freq=4)
  par(mfrow=c(1,1))
  Xt=diff(log(Datos))*100
  Xt=diff(Xt)
  Xt=ts(Xt[12:(164+(i))],start=c(1978,2),freq=4)
  ...
  long$IRLTLT01GBM156N=as.numeric(long$IRLTLT01GBM156N)
  long=long[73:252,]
  short_ts=ts(short$IRSTCI01GBM156N[1:(154+(i))],start = c(1978,1),freq=4)
  long_ts=ts(long$IRLTLT01GBM156N[1:(154+(i))],start = c(1978,1),freq=4)
  Datos=as.data.frame(cbind(long_ts,short_ts))
  names(Datos)=c("long","short")
  Datos$spread=Datos$long-Datos$short
  spread=ts(Datos$spread,start=c(1978,1),freq=4)
...
Comparacion=fread("PIB_est_uk.csv",sep=",")
Comparacion=ts(Comparacion$CPMNACNSAB1GQUK,start=c(1975,1),freq=4)
Comp_des=ts(Comparacion[165:181],start = c(2016,1),freq=4)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_1_pib_spread_uk.xlsx",overwrite = T)
...
for (i in 0:7) {
  ...
  Xt=diff(log(Datos))*100
  Xt=diff(Xt)
  Xt=ts(Xt[12:(164+(2*i))],start=c(1978,2),freq=4)
  ...
  long$IRLTLT01GBM156N=as.numeric(long$IRLTLT01GBM156N)
  long=long[73:252,]
  short_ts=ts(short$IRSTCI01GBM156N[1:(154+(2*i))],start = c(1978,1),freq=4)
  long_ts=ts(long$IRLTLT01GBM156N[1:(154+(2*i))],start = c(1978,1),freq=4)
  Datos=as.data.frame(cbind(long_ts,short_ts))
  names(Datos)=c("long","short")
  Datos$spread=Datos$long-Datos$short
  spread=ts(Datos$spread,start=c(1978,1),freq=4)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_2_pib_spread_uk.xlsx",overwrite = T)
...
for (i in 0:4) {
  ...
  Xt=diff(log(Datos))*100
  Xt=diff(Xt)
  Xt=ts(Xt[12:(164+(3*i))],start=c(1978,2),freq=4)
  ...
  long$IRLTLT01GBM156N=as.numeric(long$IRLTLT01GBM156N)
  long=long[73:252,]
  short_ts=ts(short$IRSTCI01GBM156N[1:(154+(3*i))],start = c(1978,1),freq=4)
  long_ts=ts(long$IRLTLT01GBM156N[1:(154+(3*i))],start = c(1978,1),freq=4)
  Datos=as.data.frame(cbind(long_ts,short_ts))
  names(Datos)=c("long","short")
  Datos$spread=Datos$long-Datos$short
  spread=ts(Datos$spread,start=c(1978,1),freq=4)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_3_pib_spread_uk.xlsx",overwrite = T)
...
for (i in 0:3) {
  ...
  Xt=diff(log(Datos))*100
  Xt=diff(Xt)
  Xt=ts(Xt[12:(164+(4*i))],start=c(1978,2),freq=4)
  ...
  long$IRLTLT01GBM156N=as.numeric(long$IRLTLT01GBM156N)
  long=long[73:252,]
  short_ts=ts(short$IRSTCI01GBM156N[1:(154+(4*i))],start = c(1978,1),freq=4)
  long_ts=ts(long$IRLTLT01GBM156N[1:(154+(4*i))],start = c(1978,1),freq=4)
  Datos=as.data.frame(cbind(long_ts,short_ts))
  names(Datos)=c("long","short")
  Datos$spread=Datos$long-Datos$short
  spread=ts(Datos$spread,start=c(1978,1),freq=4)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_4_pib_spread_uk.xlsx",overwrite = T)
...
Modelo_ar=forecast::Arima(Xt,order=c(2,0,0),seasonal = c(2,0,0), include.mean = F,fixed=c(NA,NA,NA,NA))
coeftest(Modelo_ar)
par(mfrow=c(2,1))
...
for (i in 0:14) {
  ...
  Xt=diff(Xt)
  Xt=ts(Xt[12:(164+(i))],start=c(1978,2),freq=4)
  refit=Arima(Xt,order=c(2,0,0),seasonal = c(2,0,0), include.mean = F,fixed=c(NA,NA,NA,NA),model=Modelo_ar)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_AR_pib_uk.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_AR_pib_uk.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_AR_pib_uk.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_AR_pib_uk.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_EXP_pib_uk.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_EXP_pib_uk.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_EXP_pib_uk.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_EXP_pib_uk.xlsx",overwrite = T)
