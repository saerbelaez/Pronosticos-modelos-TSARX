...
library(tseries) 
jb=jarque.bera.test(res) # prueba de normalidad
jb$statistic
jb$p.value    
...
pronosticos<-function(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
{
  ...
  for (i in 1:NN)
  {
    ...
    for (hh in 1:LH)
    {
      zv[nx+hh]=0.4083*zv[nx-hh-1]+rnorm(1, mean=0, sd=sqrt(1975))  ## el kernel de transici?n, variable umbral
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_1_pib_spread_usa.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_2_pib_spread_usa.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_3_pib_spread_usa.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_4_pib_spread_usa.xlsx",overwrite = T)
...
par(mfrow=c(2,1))
acf(Xt, main="",xlab="Tiempo",ylab="Residuales",lag.max=50)        # función de autocorrelación muestral
pacf(Xt, main="",xlab="Tiempo",ylab="Residuales",lag.max=50)       # función de autocorrelación parcial muestral
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_AR_pib_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_AR_pib_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_AR_pib_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_AR_pib_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_EXP_pib_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_EXP_pib_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_EXP_pib_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_EXP_pib_usa.xlsx",overwrite = T)
