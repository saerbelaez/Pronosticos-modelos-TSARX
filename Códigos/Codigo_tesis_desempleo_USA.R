...
h=25
s=4
step.thv=0.082 #se ajusta el tamaño del paso de acuerdo con la tasa de aceptación
d0=3
...
pronosticos<-function(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
{
  ...
  for (i in 1:NN)
  {
    ...
    for (hh in 1:LH)
    {
      zv[nx+hh]=0.7114+0.3182*zv[nx+hh-1]+rnorm(1, mean=0, sd=sqrt(0.6504))   ## SE CAMBIA LA FORMULA, el kernel de transici?n, variable umbral
    }
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_Desempleo_pib_usa.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_desempleo_pib_usa.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_desempleo_pib_usa.xlsx",overwrite = T)
...
Pronostico=ts(CC[,1],start(2011,1),freq=4)
Comparacion=fread("Unemployment quarterly.csv",sep=";",dec=",")
Comparacion=Comparacion[252:289,]
Comp_des=ts(Comparacion$V2,start = c(2010,4),freq=4)
Comp_des=diff(Comp_des)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_desempleo_pib_usa.xlsx",overwrite = T)
