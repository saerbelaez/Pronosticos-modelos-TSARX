...
h=25
s=12
step.thv=0.0525 #se ajusta el tamaño del paso de acuerdo con 
d0=3
...
co=0.15874####Valor del cuantil aproximado para cusumsq para n/2
...
pronosticos<-function(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
{
  ...
  for (i in 1:NN)
  {
    ...
    for (hh in 1:LH)
    {
      zv[nx+hh]=0.1893*zv[nx+hh-1]+rnorm(1, mean=0, sd=sqrt(0.2973))   ## SE CAMBIA LA FORMULA, el kernel de transici?n, variable umbral
    }
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"Resultados/Pronosticos_1_ISE_spread.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"Resultados/Pronosticos_2_ISE_spread.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"Resultados/Pronosticos_3_ISE_spread.xlsx",overwrite = T)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"Resultados/Pronosticos_4_ISE_spread.xlsx",overwrite = T)
