...
desempleo=fread("Unemployment quarterly.csv",sep=";",dec=",")
desempleo=ts(desempleo$V2[89:252],start=c(1970,1),freq=4)
Xt=diff(desempleo,lag=1)
gdp=fread("GDPC1.csv",sep=",")
gdp=ts(gdp$GDPC1[89:252],start = c(1970,1),freq=4)
Zt=diff(log(gdp))*100
...
co=0.13461####Valor del cuantil aproximado para cusumsq para n/2
...
pronosticos<-function(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
{
  ...
  for (i in 1:NN)
  {
    ...
    for (hh in 1:LH)
    {
      zv[nx+hh]= 0.7114+0.3182*zv[nx+hh-1]+rnorm(1, mean=0, sd=sqrt(0.6504))  ## el kernel de transici?n, variable umbral
    }  
...
for (i in 0:36) {
  set.seed(525)
  desempleo=fread("Unemployment quarterly.csv",sep=";",dec=",")
  desempleo=ts(desempleo$V2[89:(252+(i))],start=c(1970,1),freq=4)
  Xt=diff(desempleo,lag=1)
  gdp=fread("GDPC1.csv",sep=",")
  gdp=ts(gdp$GDPC1[89:(252+(i))],start = c(1970,1),freq=4)
  Zt=diff(log(gdp))*100
  thresVar=Zt
  x=Xt
...
Pronostico=ts(AA[,1],start=c(2011,1),freq=4)
Comparacion=fread("Unemployment quarterly.csv",sep=";",dec=",")
Comparacion=Comparacion[252:289,]
Comp_des=ts(Comparacion$V2,start = c(2010,4),freq=4)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_1_desempleo_pib_usa.xlsx",overwrite = T)
...
d0=3
step.thv=0.05
AA<-matrix(NA,nrow=19, ncol=LH)


for (i in 0:18) {
  set.seed(525)
  desempleo=fread("Unemployment quarterly.csv",sep=";",dec=",")
  desempleo=ts(desempleo$V2[89:(252+(2*i))],start=c(1970,1),freq=4)
  Xt=diff(desempleo,lag=1)
  gdp=fread("GDPC1.csv",sep=",")
  gdp=ts(gdp$GDPC1[89:(252+(2*i))],start = c(1970,1),freq=4)
  Zt=diff(log(gdp))*100
  x=Xt
  thresVar=Zt
  p=pronosticos(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_2_desempleo_pib_usa.xlsx",overwrite = T)
...
d0=3
step.thv=0.05
AA<-matrix(NA,nrow=13, ncol=LH)

for (i in 0:12) {
  set.seed(525)
  desempleo=fread("Unemployment quarterly.csv",sep=";",dec=",")
  desempleo=ts(desempleo$V2[89:(252+(3*i))],start=c(1970,1),freq=4)
  Xt=diff(desempleo,lag=1)
  gdp=fread("GDPC1.csv",sep=",")
  gdp=ts(gdp$GDPC1[89:(252+(3*i))],start = c(1970,1),freq=4)
  Zt=diff(log(gdp))*100
  x=Xt
  thresVar=Zt
  p=pronosticos(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_3_desempleo_pib_usa.xlsx",overwrite = T)
...
d0=3
step.thv=0.05
AA<-matrix(NA,nrow=10, ncol=LH)

for (i in 0:9) {
  set.seed(525)
  desempleo=fread("Unemployment quarterly.csv",sep=";",dec=",")
  desempleo=ts(desempleo$V2[89:(252+(4*i))],start=c(1970,1),freq=4)
  Xt=diff(desempleo,lag=1)
  gdp=fread("GDPC1.csv",sep=",")
  gdp=ts(gdp$GDPC1[89:(252+(4*i))],start = c(1970,1),freq=4)
  Zt=diff(log(gdp))*100
  x=Xt
  thresVar=Zt
  p=pronosticos(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
...
Pronostico=ts(CC[,1],start=c(2011,1),freq=4)
Comparacion=fread("Unemployment quarterly.csv",sep=";",dec=",")
Comparacion=Comparacion[252:289,]
Comp_des=ts(Comparacion$V2,start = c(2010,4),freq=4)
Comp_des=diff(Comp_des)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_TAR_4_desempleo_pib_usa.xlsx",overwrite = T)
...
Af=0.948 ###Cuantil del 95% para la estad?stica cusum
co=0.12819####Valor del cuantil aproximado para cusumsq para n/2
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_AR_desempleo_usa.xlsx",overwrite = T)

###Ponósticos 2 pasos adelante
AA=matrix(NA,nrow=19,ncol=2)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_AR_desempleo_usa.xlsx",overwrite = T)



###Ponósticos 3 pasos adelante
AA=matrix(NA,nrow=13,ncol=3)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_AR_desempleo_usa.xlsx",overwrite = T)

###Ponósticos 4 pasos adelante
AA=matrix(NA,nrow=10,ncol=4)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_AR_desempleo_usa.xlsx",overwrite = T)
...
Af=0.948 ###Cuantil del 95% para la estad?stica cusum
co=0.12134####Valor del cuantil aproximado para cusumsq para n/2
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_EXP_desempleo_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_EXP_desempleo_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_EXP_desempleo_pib_usa.xlsx",overwrite = T)
...
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_EXP_desempleo_usa.xlsx",overwrite = T)
