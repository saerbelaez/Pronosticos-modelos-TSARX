...
setwd("D:/sarbelaez/Documents/Maestría/Tesis/Bases de datos/EE UU/")
Base=read.xlsx("PIB_usa.xlsx",startRow = 7)
Base_2=read.xlsx("PIB_usa.xlsx",startRow = 7,sheet=2)
Datos=ts(rbind(t(Base[1,154:256]),t(Base_2[1,3:26])),start=c(1984,4),freq=4)
length(Datos)  
Xt=diff(log(Datos))*100
spread=read.xlsx("Spread_usa.xlsx",startRow = 11)
Zt=ts(diff(spread[92:218,2])*100,start = c(1985,1),freq=4)
...
h=25
s=4
step.thv=0.86 #se ajusta el tamaño del paso de acuerdo con la tasa de aceptación
d0=3
...
co=0.1442####Valor del cuantil aproximado para cusumsq para n/2
...
pronosticos<-function(LH, x, thresVar, Iteration, Burnin, step.thv, d0)
{
  ...
  for (i in 1:NN)
  {
    ...
    for (hh in 1:LH)
    {
      zv[nx+hh]=0.4083*zv[nx+hh-1]+rnorm(1, mean=0, sd=sqrt(1975))   ## SE CAMBIA LA FORMULA, el kernel de transici?n, variable umbral
    }
...
for (i in 0:14) {
  ...
  Base=read.xlsx("PIB_usa.xlsx",startRow = 7)
  Base_2=read.xlsx("PIB_usa.xlsx",startRow = 7,sheet=2)
  Datos=ts(rbind(t(Base[1,154:256]),t(Base_2[1,3:(26+(i))])),start=c(1984,4),freq=4)
  
  Xt=diff(log(Datos))*100
  spread=read.xlsx("Spread_usa.xlsx",startRow = 11)
  Zt=ts(diff(spread[92:(218+(i)),2])*100,start = c(1985,1),freq=4)
  x2=Xt
  thresVar2=Zt
...
Comparacion=read.xlsx("PIB_usa.xlsx",startRow = 7,sheet=2)
Comparacion=Comparacion[1,26:41,]
Comp_des=ts(t(Comparacion),start=c(2016,2),freq=4)
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_1_pib_spread_usa.xlsx",overwrite = T)
...
for (i in 0:7) {
  ...
  Base=read.xlsx("PIB_usa.xlsx",startRow = 7)
  Base_2=read.xlsx("PIB_usa.xlsx",startRow = 7,sheet=2)
  Datos=ts(rbind(t(Base[1,154:256]),t(Base_2[1,3:(26+(2*i))])),start=c(1984,4),freq=4)
  
  Xt=diff(log(Datos))*100
  spread=read.xlsx("Spread_usa.xlsx",startRow = 11)
  Zt=ts(diff(spread[92:(218+(2*i)),2])*100,start = c(1985,1),freq=4)
  x2=Xt
  thresVar2=Zt
  p=pronosticos(LH, x2, thresVar2, Iteration, Burnin, step.thv, d0)
  px=p$seriex
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_2_pib_spread_usa.xlsx",overwrite = T)
...
for (i in 0:4) {
  ...
  Base=read.xlsx("PIB_usa.xlsx",startRow = 7)
  Base_2=read.xlsx("PIB_usa.xlsx",startRow = 7,sheet=2)
  Datos=ts(rbind(t(Base[1,154:256]),t(Base_2[1,3:(26+(3*i))])),start=c(1984,4),freq=4)
  
  Xt=diff(log(Datos))*100
  spread=read.xlsx("Spread_usa.xlsx",startRow = 11)
  Zt=ts(diff(spread[92:(218+(3*i)),2])*100,start = c(1985,1),freq=4)
  x2=Xt
  thresVar2=Zt
  p=pronosticos(LH, x2, thresVar2, Iteration, Burnin, step.thv, d0)
  px=p$seriex
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_3_pib_spread_usa.xlsx",overwrite = T)
...
Base=read.xlsx("PIB_usa.xlsx",startRow = 7)
Base_2=read.xlsx("PIB_usa.xlsx",startRow = 7,sheet=2)
Datos=ts(rbind(t(Base[1,154:256]),t(Base_2[1,3:(26+(0))])),start=c(1984,4),freq=4)

for (i in 0:3) {
  set.seed(526)
  Base=read.xlsx("PIB_usa.xlsx",startRow = 7)
  Base_2=read.xlsx("PIB_usa.xlsx",startRow = 7,sheet=2)
  Datos=ts(rbind(t(Base[1,154:256]),t(Base_2[1,3:(26+(4*i))])),start=c(1984,4),freq=4)
  
  Xt=diff(log(Datos))*100
  spread=read.xlsx("Spread_usa.xlsx",startRow = 11)
  Zt=ts(diff(spread[92:(218+(4*i)),2])*100,start = c(1985,1),freq=4)
  x2=Xt
  thresVar2=Zt
  p=pronosticos(LH, x2, thresVar2, Iteration, Burnin, step.thv, d0)
  px=p$seriex
...
legend("topright",                     
       ...
       lty = 1,
       col = 1:2)
write.xlsx(data,"D:/sarbelaez/Documents/Maestría/Tesis/Datos finales/Resultados/Pronosticos_4_pib_spread_usa.xlsx",overwrite = T)
